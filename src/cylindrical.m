...
function pan = cylindrical(imageArray, minInliers, flength)
N = numel(imageArray);
pan = {};
...
%     imageArray{i} = imread(imScene{i});
    ...
    imageArray{i} = projectToCylinder(imageArray{i}, flength);
end
pan = planar(imageArray, minInliers);
